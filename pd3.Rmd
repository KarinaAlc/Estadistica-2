...
Es importante revisar el **signo** del coeficiente, ya que dependiendo de eso procederemos a interpretar. En este caso, el coeficiente es negativo; es decir, *la relación es inversa.* La interpretación de la probabilidad tendrá la siguiente forma: cuando la VI aumenta o es 1 (para dicotómicas), la probabilidad de que la VD sea 1 (se de el caso de éxito) disminuye en ...
...
Apliquémoslo en nuestro modelo:

```{r}
marg1=marginaleffects(modelo1)
summary(marg1)[c(1,3)]
...
```{r}
marg2=marginaleffects(modelo2)
summary(marg2)[,c(1,3)]
```

Interpretemos **(Ojo: las variables aparecen en orden alfabético)**

-   Si el docente ha tenido o tiene cáncer, la probabilidad de que quiera retornar a clases presenciales disminuye, en promedio, en 0.1134 o en 11.34%

-   Si el docente ha tenido o tiene depresión, la probabilidad de que quiera retornar a clases presenciales disminuye, en promedio, en 0.0328 o en 3.28%

-   Si el docente vive con personas de la tercera edad, la probabilidad de que quiera retornar a clases presenciales disminuye, en promedio, en 0.0478 o en 4.78%
