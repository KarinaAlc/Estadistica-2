...
```{r, fig.show='hide',warning=FALSE,message=FALSE}
modelo1<- lm(accesoInformacion ~ Capital_Humano + Policulture + Telecommunicacion_Infrastructura + ProcesoElectoral,data=Egov)
summary(modelo1)
...
```{r, fig.show='hide',warning=FALSE,message=FALSE}
library(corrplot)
#La función cor calcula la matriz de correlaciones
...
=======
>>>>>>> baaebfed5c6cd11fcd793119f14c0ffd7a3b8ecf
...
modelo2 <- lm(accesoInformacion ~ ProcesoElectoral + Policulture + Capital_Humano + UsuariosInternet,data=Egov)
summary(modelo2)
