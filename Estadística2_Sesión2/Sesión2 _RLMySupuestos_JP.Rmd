...
```{r, fig.show='hide',warning=FALSE,message=FALSE}
modelo1<- Egov %>% lm(accesoInformacion ~ Capital_Humano + Policulture + Telecommunicacion_Infrastructura + ProcesoElectoral)
summary(modelo1)
...
modelo2 <- Egov %>% lm(accesoInformacion ~ ProcesoElectoral + Policulture + Capital_Humano + UsuariosInternet)
summary(modelo2)
