---
title: "Tidyverse y Supuestos: La revancha "
...
```{r,  fig.show='hide',warning=FALSE,message=FALSE}
#shapiro.test(modelo1$resid) #dif por muestra
```
...
Al realizar el shapiro test, observamos que el p-values es 0.04692,
menor a 0.05, por lo que no existe normalidad de los residuos El modelo
*no* pasa este supuesto.
