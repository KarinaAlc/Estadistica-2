...
Con el siguiente  comando establecemos la categoría de referencia. Donde en ref mencionamos cómo se llama esta categoría, por eso es importante tener bien etiquetadas las variables.
...
prob dictadura/prob democracia fallida (linea base)
```{r}
