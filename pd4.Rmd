...
- VI= Trade Freedom (Libertad de comercio) y Property Rights (Derecho a la propiedad privada)
...
```
Para la variable property, de la dos comparaciones con nuestra categoría de referencia, la única significativa es cuando se compara democracia con democracia fallida. 

```{r}
test.multinom(mod1,tradefree)
# Se coloca test.multinom(nombredelmodelo,variableindependiente2)
```
Para la variable tradefree, de la dos comparaciones con nuestra categoría de referencia, la única significativa es cuando se compara dictadura con democracia fallida. 
...
```
- Cuando en un país el índice de derecho a la propiedad incrementa un punto, la probabilidad de que este país presente una democracia aumenta en promedio 0.00958.
...
ProbDictadura
```
Si un país tiene 50 de indice de derecho a la propiedad y 60 de indice de libertad de comercio, tiene un 0.62 de probabilidad de ser una dictadura. 
...
Si un país tiene 50 de indice de derecho a la propiedad y 60 de indice de libertad de comercio, tiene un 0.005 de probabilidad de ser una democracia 
...
Si un país tiene 50 de indice de derecho a la propiedad y 60 de indice de libertad de comercio, tiene un 0.366 de probabilidad de ser una democracia fallida 
...
##PASO 3: RELACIÓN DE LAS VARIABLES
...
Cuando un país sí tiene poca libertad de comercio (es 1), la probabilidad de que sea democracia fallida a que sea dictadura disminuye.

- Coeficiente(busfreef_Poca): -0.2906452

Cuando un país sí tiene poca libertad de comercio (es 1), la probabilidad de que sea democracia fallida a que sea democracia disminuye.
...
## PASO 4: INTERPRETACIÓN DE COEFICIENTES OJO, USEMOS MARGINAL EFFECTS
...
Usamos los valores de 50 (property), 60 (tradefree) y si hay poca Bussines liberty (1)
...
Revisemos qué tan bien estarían categorizados mis países según mi modelo 1.

```{r}
table(demofree$regimen)
table(demofree$regimen,predict(mod1))
```
Vemos que ha categorizado a la mayoría de países bien por cada categorías.
