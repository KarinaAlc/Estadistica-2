...
```
::: custom-text
¿Una economía liberal influye en el nivel de democracia? 🤔
:::
...
clase es la relación entre el tipo de régimen político *(democracia,
democracia fallida y dictadura)* con variables económicas.
...
-   Variable dependiente= Regimen Político `regimen`
...
confirmamos que nuestras variables estén en el formato adecuado
(numérico)
...
menos probable que el estado sea dictadura a demoracia fallida.
...
Si un país tiene 80 de indice de derecho a la propiedad y 50 de indice
...
Para fines prácticos, dividamos la variable en países con *poca libertad
...
select_columns indicamos qué variable queremos
