...
-   Exploración gráfica: Plot de valores residuales frente a valores
    predichos.
...
```{r,message=FALSE}
#Exploración gráfica
check_model(modelo1,check ="qq")
```

Todos los puntos deben estar sobre la diagonal. Los dos gráficos no son
concluyentes, entonces procedo a realizar el test.

b. Pruebas de normalidad a los residuos: Lillieford (mayores a 50 casos) o Shapiro-Wilks (menores a 50 casos)
