...
Exploración gráfica: Plot de valores residuales frente a
valores predichos.
...
Exploración gráfica y pruebas de normalidad a los residuos. 
...
b.  ¿Qué tanto explica el modelo? -Revisamos el R cuadrado  que
